import concludePrompt from '../../prompts/conclude.ts'
...
app.post('/prompt/conclude', async (req, res) => {
  ...
  try {
    const intro = concludePrompt(prompt, conversationHistory, model1, model2)
